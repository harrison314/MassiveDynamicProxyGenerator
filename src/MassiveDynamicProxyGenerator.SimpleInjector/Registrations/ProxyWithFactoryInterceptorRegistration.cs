...
namespace MassiveDynamicProxyGenerator.SimpleInjector.Registrations
{
    internal class ProxyWithFactoryInterceptorRegistration : Registration
    {
        ...
        public ProxyWithFactoryInterceptorRegistration(Lifestyle lifestyle, Container container, Type implementationType, Func<IInterceptor> factory, ProxygGenerator generator)
